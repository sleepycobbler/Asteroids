...
public:
	...
	bool isLClick() const { return isLeftClick; };
	bool isRClick() const { return isRightClick; };
...
private:
	...
	static bool isMouseOnScreen;      // is the mouse on the screen?
	static bool isLeftClick;          // is mouse left-Clicking
	static bool isRightClick;         // is mouse right-Clicking
	static int mouseX;
	static int mouseY;                // the current mouse position
};
...
/***************************************************************
* MOUSE CALLBACK
* Special callback to mouse state, such as
